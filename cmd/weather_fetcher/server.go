...
func (w *WeatherFetcher) GetWeather(c context.Context, req weatherfetcher.GetWeatherRequestObject) (weatherfetcher.GetWeatherResponseObject, error) {
	...
	if err != nil {
		return weatherfetcher.GetWeather500Response{}, errors.Wrap(err, "create request")
	}
	...
	if err != nil {
		return weatherfetcher.GetWeather500Response{}, errors.Wrap(err, "request Yandex API")
	}
	defer resp.Body.Close()

	if resp.StatusCode != http.StatusOK {
		return weatherfetcher.GetWeather500Response{}, errors.Wrap(err, "status code not 200 from Yandex API")
	}

	// Assuming you want to return the response from the weather API directly
	body, err := io.ReadAll(resp.Body)
	if err != nil {
		return weatherfetcher.GetWeather500Response{}, errors.Wrap(err, "read response body from Yandex API")
	}
	...
	if err != nil {
		return weatherfetcher.GetWeather500Response{}, errors.Wrap(err, "unmarshal body from Yandex API")
	}
